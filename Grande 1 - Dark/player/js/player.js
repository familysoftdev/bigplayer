...
window.onresize = function(){
    ...
    cSize = document.getElementById("player-controller").offsetWidth;
    ...
    else if(cSize <= 840 && cSize > 564 || cSize <= 519 && cSize > 450)
    {
        pBar.style.width = "40%";
    }
    else if(cSize < 1050 && cSize > 840 || cSize <= 564 && cSize > 519)
    {
        pBar.style.width = "50%";
    }
    /*else if(cSize <= 519 && cSize > 450)
    {
        pBar.style.width = "40%";
    }*/
    /*else if(cSize <= 564 && cSize > 519)
    {
        pBar.style.width = "50%";
    }*/
}
